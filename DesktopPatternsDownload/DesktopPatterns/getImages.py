...
def drawOne(x,y):
    ...
    img= Image.open('../backgrounds/background1.png','r')
    img_w, img_h = img.size

    offset=((bg_w-img_w)/2,(bg_h-img_h)/2)
    background.paste(img,offset)
    background.save('../backgrounds/backgroundnew.png')
    background.save('../backgrounds/backgroundnew1.png')
...
def drawTwo(x,y):
    ...
    img2= Image.open('../backgrounds/background2.png','r')
...
def drawThree(x,y):
    ...
    img3= Image.open('../backgrounds/background3.png','r')
...
def saveImages(imgs, start, end):
    ...
    for i in listIterator:
        ...
        with open("../backgrounds/background"+`counter`+".png", "wb") as code:
            code.write(f.read())
        counter = 1 + counter
# ---------------------------
